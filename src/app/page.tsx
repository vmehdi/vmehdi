          ...
          <div className="relative z-10 flex h-full flex-col items-center justify-center">
            ...
            <article className="mt-6 max-w-2xl">
              <p>
                ...
                technologies. From early CSS techniques to modern frameworks, I have continuously adapted to
                advancements in the field.
              </p>
              <p>
                With over a decade of expertise in Vue.js and React, I have delivered numerous web and mobile
                applications using frameworks like Next.js, Nuxt.js, and React Native. I enjoy tackling challenges,
                staying updated with new technologies, and mentoring others.
              </p>
              <p className="mt-2">
                My core strengths lie in JavaScript and its frameworks, complemented by back- end knowledge of Node.js
                and Bun.js, enabling me to manage projects from concept to completion.
              </p>
            </article>
